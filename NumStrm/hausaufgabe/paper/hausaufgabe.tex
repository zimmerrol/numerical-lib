...
\lstinputlisting[label=src:squarematrix.h, title=\textbf{Quellcode 1:} square\_matrix.h]{source/lib/square_matrix.h}
\lstinputlisting[label=src:matrix.h, title=\textbf{Quellcode 2:} matrix.h]{source/lib/matrix.h}
\lstinputlisting[label=src:linearsystem.h, title=\textbf{Quellcode 3:} linear\_system.h]{source/lib/linear_system.h}

\lstinputlisting[label=src:matrix.cpp, title=\textbf{Quellcode 4:} matrix.cpp]{source/lib/matrix.cpp}
\lstinputlisting[label=src:linearsystem.cpp, title=\textbf{Quellcode 5:} linear\_system.cpp]{source/lib/linear_system.cpp}
\end{document}